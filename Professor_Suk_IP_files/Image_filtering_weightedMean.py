...
FilterSize = 3
WeightedMeanFilter = np.array([[1,2,1], [2,4,2], [1,2,1]])
WeightedMeanFilter = WeightedMeanFilter/np.sum(WeightedMeanFilter)

Image_New = Im_filtering(lena, WeightedMeanFilter, FilterSize)
